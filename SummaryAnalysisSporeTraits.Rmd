...
# file using updated trait data, but these are missing several species for which there used to be trait data
...
temp %>% 
  ...
  mutate(Life_style = recode(host.assoc, no='free-living', yes='host-associated')) %>% 
