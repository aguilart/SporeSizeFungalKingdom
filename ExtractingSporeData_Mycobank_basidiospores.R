...
Basidiospores$measure_orig[which(s_==4)][1]<-"10.0-10.77-11.5(-12.0) x 5.0-5.53-6.0"
Basidiospores$measure_orig[which(s_==4)][2]<-"4-6.01-7.5 x 1.5-2.78-3.5"
Basidiospores$measure_orig[which(s_==4)][3]<-"21.5-23.8-24.7-27.0 x 4.5-5.2-5.7-6.5"
Basidiospores$measure_orig[which(s_==4)][4]<-"21.5-23.8-24.7-27.0 x 4.5-5.2-5.7-6.5"
Basidiospores$measure_orig[which(s_==4)][5]<-"21.0-23.2-27.6-29.0 x 5.0-6.1-6.8-8.0"
Basidiospores$measure_orig[which(s_==4)][6]<-"21.0-23.2-27.6-29.0 x 5.0-6.1-6.8-8.0"
Basidiospores$measure_orig[which(s_==4)][7]<-"18.0-20.2-20.3-22.5 x 4.5-5.1-5.2-5.5"
Basidiospores$measure_orig[which(s_==4)][8]<-"(4.5-)5-6.4-8 x 2-2.7-3"
Basidiospores$measure_orig[which(s_==4)][9]<-"7-7.9-9 x 2-2.9-3·5"
Basidiospores$measure_orig[which(s_==4)][10]<-"7-7.9-9 x 2-2.9-3.5"
Basidiospores$measure_orig[which(s_==4)][11]<-"(4.5-)5-6.4-8 x 2-2.7-3"
...
#There were more problems with missing "x". See: Basidiospores$measure_orig[s_==3]. These ones were thoroughly checked!
Basidiospores$measure_orig[which(s_==3)][1]<-"3-7 x 1-2"#Look at "Ophiostoma africanum_58406" to check why the numbers are so oddly written
Basidiospores$measure_orig[which(s_==3)][2]<-"(28.5-)30.0-34.85-40.0(-44) x 12.0-14.0-16.0(-16.5)"
Basidiospores$measure_orig[which(s_==3)][3]<-"(28.5-)30.0-34.85-40.0(-44) x 12.0-14.0-16.0(-16.5)" 
Basidiospores$measure_orig[which(s_==3)][4]<-"(28.5-)30.0-34.85-40.0(-44) x 12.0-14.0-16.0(-16.5)"
Basidiospores$measure_orig[which(s_==3)][5]<-"(12.5-)13.0-13.75-14.5(-15.5) x (-3.5)4.0-4.5-5.0(-5.5)"
Basidiospores$measure_orig[which(s_==3)][6]<-"(12.0-)12.5-13.77-15.0(-16.5) x (-3.0)3.5-4.0-4.5"
Basidiospores$measure_orig[which(s_==3)][7]<-"(7.5-)8.5-10(-11) x (5-)6-7.5(-8) x (3-)4-5" 
Basidiospores$measure_orig[which(s_==3)][8]<-"(7.5-)8.5-10(-11) x (5-)6-7.5(-8) x (3-)4-5"
Basidiospores$measure_orig[which(s_==3)][9]<-"16.5-20.5 x 13.5-15 x 11-12.5"
Basidiospores$measure_orig[which(s_==3)][10]<-"16.5-21 x 10.5-13 x 9-11.5"
Basidiospores$measure_orig[which(s_==3)][11]<-"17.5-21.5 x 11-13 x 9-11"
Basidiospores$measure_orig[which(s_==3)][12]<-"18-22 x 11.5-14 x 9.5-11"
Basidiospores$measure_orig[which(s_==3)][13]<-"28-33.0-38 x 5.0-6.0-7.0"
Basidiospores$measure_orig[which(s_==3)][14]<-"28-33.0-38 x 5.0-6.0-7.0"
Basidiospores$measure_orig[which(s_==3)][15]<-"22-26-30 x 5.0-5.9-7.0" 
Basidiospores$measure_orig[which(s_==3)][16]<-"22-26-30 x 5.0-5.9-7.0"
Basidiospores$measure_orig[which(s_==3)][17]<-"18.0-22.5 x 5.0-7.5"
Basidiospores$measure_orig[which(s_==3)][18]<-"23-26.3-28 x 10-11.6-12.5"
Basidiospores$measure_orig[which(s_==3)][19]<-"23-26.3-28 x 10-11.6-12.5"
Basidiospores$measure_orig[which(s_==3)][20]<-"5-8 x 4-5.5 x 3-4"
Basidiospores$measure_orig[which(s_==3)][21]<-"(21-22) 22.4-24.5 (25-26) x (10.5) 11.4-12 (13)"
...
#changes can be found in the script Fixing_Missing_x_Basidiospores.R
...
Basidiospores$measure_orig[is.na(Basidiospores$Dimension_1)][206]<- "(8-)10-[11.6]-14(-15) x 4-[5.4]-7" 
Basidiospores$measure_orig[is.na(Basidiospores$Dimension_1)][257]<- "12-[13.9]-16 x 6-[7.9]-10"
Basidiospores$measure_orig[is.na(Basidiospores$Dimension_1)][260]<- "12-13 x 4-4.5"                                                 
Basidiospores$measure_orig[is.na(Basidiospores$Dimension_1)][261]<- "30-36 x 13-17"                                                 
Basidiospores$measure_orig[is.na(Basidiospores$Dimension_1)][262]<- "(15.2-)15.8-18.3(-19.6) x (5.8-)6.2-6.9(-7.1)"                 
Basidiospores$measure_orig[is.na(Basidiospores$Dimension_1)][263]<- "(12.5-)16-21(-25.5) x (4.5-)5.5-6.5(-7)"                       
Basidiospores$measure_orig[is.na(Basidiospores$Dimension_1)][264]<- "(15-)17.5-21.5(-24.5) x (5-)5.5-6.5(-8)"                       
Basidiospores$measure_orig[is.na(Basidiospores$Dimension_1)][265]<- "(13-)14.5-18(-22) x (4-)5-6(-7)"                               
Basidiospores$measure_orig[is.na(Basidiospores$Dimension_1)][266]<- "(13-)14.5-18(-22) x (4-)5-6(-7)"                               
Basidiospores$measure_orig[is.na(Basidiospores$Dimension_1)][267]<- "(13-)15-19(-21) x (5-)5.5-6(-7)"                               
Basidiospores$measure_orig[is.na(Basidiospores$Dimension_1)][268]<- "(14-)15.5-23(-33.5) x (3.5-)4-5"                               
Basidiospores$measure_orig[is.na(Basidiospores$Dimension_1)][269]<- "(18.5-)20-27(-37) x (4-)4.5-5"                                 
Basidiospores$measure_orig[is.na(Basidiospores$Dimension_1)][270]<- "(18.5-)20-27(-37) x (4-)4.5-5"                                 
Basidiospores$measure_orig[is.na(Basidiospores$Dimension_1)][271]<- "(12-)14-16.5(-17.5) x (4.5-)5-5.5(-6)"                         
Basidiospores$measure_orig[is.na(Basidiospores$Dimension_1)][272]<- "(11.5-)14.5-19(-23.5) x (4-)4.5-5.5(-6)"                       
